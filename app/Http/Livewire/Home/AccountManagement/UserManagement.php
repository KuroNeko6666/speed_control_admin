...
class UserManagement extends Component
{
    ...
    {
        $accounts =  User::latest()->filter(["search" => $this->search])->filter(['role' => 'user'])->paginate(10)->withQueryString();
        return view('livewire.home.account-management.user-management', ['accounts' => $accounts])
