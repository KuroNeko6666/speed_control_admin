...
class OperatorManagement extends Component
{
    use WithPagination;
    public $search;
    ...
    {
        $accounts =  User::latest()->filter(["search" => $this->search])->filter(['role' => 'operator'])->paginate(10)->withQueryString();
        return view('livewire.home.account-management.operator-management', ['accounts' => $accounts])
