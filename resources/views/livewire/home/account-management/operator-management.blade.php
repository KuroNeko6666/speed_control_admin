        ...
        <div class="card">
            <div class="card-body">
                <div class="row justify-align-between">
                    <div class="col">
                        <h4 class="card-title">Operator Management</h4>
                    </div>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="d-flex">
                                            ...
                                            <button type="button" class="btn btn-danger btn-rounded btn-icon btn-sm" data-bs-toggle="modal" data-bs-target="#deleteModal" wire:click='show({{ $account->id }})'>
                                                <i class="ti-trash"></i>
                                            </button>
                                        </div>
                                    </td>
    ...
    <div class="modal fade" id="deleteModal" tabindex="-1" aria-labelledby="deleteModal" aria-hidden="true"
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Close</button>
                    <button type="submit" class="btn btn-danger" data-bs-dismiss="modal" wire:click='delete'>Delete</button>
                </div>
